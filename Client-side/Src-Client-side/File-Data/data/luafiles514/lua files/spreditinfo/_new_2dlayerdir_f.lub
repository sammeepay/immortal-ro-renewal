...
LAYER_ALL_TABLE_LIST = {
  ...
  [JOBID.JT_HANBOK] = JOBID.JT_SANTA,
  [JOBID.JT_OKTOBERFEST] = JOBID.JT_SANTA,
  [JOBID.JT_SUMMER2] = JOBID.JT_SANTA,
  ...
  [JOBID.JT_FROG_NINJA_B] = JOBID.JT_FROG_NINJA,
  [JOBID.JT_FROG_KAGEROU_B] = JOBID.JT_FROG_NINJA,
  [JOBID.JT_FROG_OBORO_B] = JOBID.JT_FROG_NINJA,
  [JOBID.JT_PORING_TAEKWON_B] = JOBID.JT_PORING_NOVICE,
  [JOBID.JT_PORING_STAR_B] = JOBID.JT_PORING_NOVICE,
  [JOBID.JT_FROG_LINKER_B] = JOBID.JT_FROG_LINKER,
  [JOBID.JT_PECO_GUNNER_B] = JOBID.JT_PECO_SWORD,
  [JOBID.JT_PECO_REBELLION_B] = JOBID.JT_PECO_REBELLION,
  [JOBID.JT_STAR2_B] = JOBID.JT_STAR2,
  [JOBID.JT_STAR_EMPEROR] = JOBID.JT_STAR_EMPEROR,
  [JOBID.JT_SOUL_REAPER] = JOBID.JT_SOUL_REAPER,
  [JOBID.JT_STAR_EMPEROR_B] = JOBID.JT_STAR_EMPEROR,
  [JOBID.JT_SOUL_REAPER_B] = JOBID.JT_SOUL_REAPER,
  [JOBID.JT_STAR2_EMPEROR] = JOBID.JT_STAR2_EMPEROR,
  [JOBID.JT_STAR2_EMPEROR_B] = JOBID.JT_STAR2_EMPEROR,
  [JOBID.JT_HAETAE_STAR_EMPEROR] = JOBID.JT_HAETAE_STAR_EMPEROR,
  [JOBID.JT_HAETAE_SOUL_REAPER] = JOBID.JT_HAETAE_SOUL_REAPER,
  [JOBID.JT_HAETAE_STAR_EMPEROR_B] = JOBID.JT_HAETAE_STAR_EMPEROR,
  [JOBID.JT_HAETAE_SOUL_REAPER_B] = JOBID.JT_HAETAE_SOUL_REAPER
}
