...
<form action="<?php echo $this->urlWithQs ?>" method="post" name="edit_item_form">
	...
	<table class="vertical-table">
		<tr>
			<th><label for="item_id">ID</label></th>
			<td><label><strong><?php echo htmlspecialchars($itemID) ?></strong></label></td>
			<th><label for="view">ดู ID</label></th>
		...
		<tr>
			...
			<td colspan="3">
				...
				<p class="action">
					...
					<span class="anchor" onclick="$('#equip_upper option').attr('selected', false)">เลือกปกติ</span>
				</p>
			</td>
		</tr>
		<tr>
			...
			<td colspan="3">
				...
				<p class="action">
					...
					<span class="anchor" onclick="$('#equip_jobs option').attr('selected', false)">เลือกปกติ</span>
				</p>
			</td>
		</tr>
		<tr>
