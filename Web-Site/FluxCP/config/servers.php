...
return array(
	...
	array(
		...
		'DbConfig'       => array(
			...
			'Database'   => 'ragnarok',
			'Persistent' => true,
			'Timezone'   => 'Asia/Bangkok' // Example: '+0:00' is UTC.
		...
		'LogsDbConfig'   => array(
			...
			'Database'   => 'ragnarok',
			'Persistent' => true,
			'Timezone'   => 'Asia/Bangkok' // Possible values is as described in the comment in DbConfig.
		),
		...
		'CharMapServers' => array(
			array(
				...
				'Renewal'         => true,
				'MaxCharSlots'    => 12,
				'DateTimezone'    => 'Asia/Bangkok', // Specifies game server's timezone for this char/map pair. (See: http://php.net/timezones)
